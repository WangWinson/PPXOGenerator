...
//Get Amazon shopping Cart page details
...
//If modal not yet injected, inject
else {
    //cart page
        ...
        puDetails =
            {
                amount: {
                    ...
                    breakdown: { item_total: { currency_code: details[0].unit_amount.currency_code, value: totalAmount.toString() } }
                },
                items: details
            };
    }
